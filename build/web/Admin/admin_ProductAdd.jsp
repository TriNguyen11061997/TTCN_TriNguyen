...
<html>   
    ...
    <body>
        <div class="wrap">
            ...
            <div class="main">
                <h2 style="text-align: center;margin-top: 20px; color:darkviolet ">THÊM MỚI SẢN PHẨM</h2>               
                <div class="container">
                    <div class="row">                       
                            ...
                            <div class='form-group'>                                                          
                                <div class='col-xs-12 form-group'  id="left3">
                                    <%GeNumberingsController objGeNumberingsController = new GeNumberingsController();
                                        String no = objGeNumberingsController.GetNo("ICProducts");
                                    %>
                                    <label class="control-label locked" for="name-input-field">Mã sản phẩm</label>
                                    <input id="name" name="ICProductNo"  class="form-control" value="<%= no%>" type="text" required="true" readonly="">                                  
                                </div>
