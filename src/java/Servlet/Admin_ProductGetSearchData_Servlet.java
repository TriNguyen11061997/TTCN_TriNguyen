 ...
 * @author Trí Nguyễn
 */
public class Admin_ProductGetSearchData_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ICProductsInfo> listProduct = productController.GetSearchData(request.getParameter("info"));
        HttpSession session = request.getSession();
        session.getAttribute("HREmployeeID");
