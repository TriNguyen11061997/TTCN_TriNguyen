 ...
 * @author Trí Nguyễn
 */
public class Admin_SaleOrderSearchDataForEmployee_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ARSaleOrdersInfo> listSaleOrder = objARSaleOrdersController.GetSearchDataForEmployee(request.getParameter("info"));
