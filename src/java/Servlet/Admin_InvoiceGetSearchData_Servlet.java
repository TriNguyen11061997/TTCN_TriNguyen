 ...
 * @author Trí Nguyễn
 */
@WebServlet(name = "Admin_InvoiceGetSearchData_Servlet", urlPatterns = {"/Admin_InvoiceGetSearchData"})
public class Admin_InvoiceGetSearchData_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ARInvoicesInfo> listInvoice = objARInvoicesController.GetSearchData(request.getParameter("info"));
            request.setAttribute("listInvoice", listInvoice);
            request.setAttribute("listSaleOrder", listSaleOrder);
            request.getRequestDispatcher("Admin/admin_InvoiceManagement.jsp").include(request, response);
