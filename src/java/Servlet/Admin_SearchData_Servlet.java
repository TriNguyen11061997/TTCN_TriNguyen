 ...
 * @author Trí Nguyễn
 */
public class Admin_SearchData_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ARSaleOrdersInfo> listSaleOrder = objARSaleOrdersController.GetSearchDataForAdmin(request.getParameter("info"));
