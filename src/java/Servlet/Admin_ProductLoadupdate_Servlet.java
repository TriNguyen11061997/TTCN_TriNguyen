 ...
 * @author PC
 */
@WebServlet(name = "Admin_ProductLoadupdate_Servlet", urlPatterns = {"/Admin_ProductLoadupdate_Servlet"})
public class Admin_ProductLoadupdate_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("HREmployeeID") != null) {
            ...
            if(iCProductsInfo != null){
                ...
                request.getRequestDispatcher("/Admin/admin_ProductUpdate.jsp").include(request, response);
            }
            else{
